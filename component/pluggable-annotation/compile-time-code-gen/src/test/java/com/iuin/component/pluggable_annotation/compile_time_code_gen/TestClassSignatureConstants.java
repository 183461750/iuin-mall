...
public class TestClassSignatureConstants {
    ...
    public void testBasicConstantsClass() {
        // 验证类名常量
        assertEquals(
                "com.iuin.component.pluggable_annotation.compile_time_code_gen.TestClassSignatureConstants$BasicTestClass",
    ...
    public void testEnumMode() {
        // 验证类名枚举值
        assertEquals(
                "com.iuin.component.pluggable_annotation.compile_time_code_gen.TestClassSignatureConstants$EnumTestClass",
    ...
    public void testCustomPrefixSuffix() {
        // 验证自定义前缀和后缀的常量名
        assertEquals(
                "com.iuin.component.pluggable_annotation.compile_time_code_gen.TestClassSignatureConstants$CustomPrefixSuffixClass",
