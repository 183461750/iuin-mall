package com.iuin.mall.adapter.businessservice.create_commodity_sales_area_template.web;
 ...
 */
@RestController
@RequestMapping("/web/create_-commodity_-sales_-area_-template")
@Api(value = "/web/create_-commodity_-sales_-area_-template", tags = "创建商品销售区域模版-B端")
public class Create_Commodity_Sales_Area_TemplateWebController {
