...
public class Knife4jConfiguration {
    ...
    private static final String BASE_PACKAGE = "com.iuin.mall.adapter";

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("iuin-mall")
                .description("iuin商城 (generated by visual-ddd generator)")
                .termsOfServiceUrl("/")
                .version("1.0.0")
