 ...
 */
package com.iuin.component.cache.reactive;

import com.iuin.component.cache.TestConfiguration;
...
class ReactiveRedisTests {
    ...
    private static final String PREFIX = ReactiveRedisTests.class.getSimpleName();
